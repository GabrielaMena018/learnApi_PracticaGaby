...
public class AuthController {
    ...
    private ResponseEntity<String>login(@Valid @RequestBody UserDTO userDTO, HttpServletResponse response){
        ...
        if (userDTO.getCorreo()== null || userDTO.getCorreo().isBlank()|| userDTO.getCorreo().isEmpty()||
                userDTO.getContrasena()==null || userDTO.getContrasena().isBlank()|| userDTO.getContrasena().isEmpty()){
        ...
        if (service.login(userDTO.getCorreo(),userDTO.getContrasena())){
